  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={brand.main}>
      <Container style={brand.container}>
        ...
        <Heading style={brand.h1}>Scorecard for {candidateName ?? "a candidate"}</Heading>
        <Text style={brand.text}>
          {senderName ? `${senderName} shared` : "Someone shared"} an interview scorecard with you
          {roleTitle ? ` for the ${roleTitle} role` : ""}. Click below to review the full
          evaluation.
        </Text>
        <Button style={brand.button} href={shareUrl ?? "#"}>
          Open scorecard
        </Button>
